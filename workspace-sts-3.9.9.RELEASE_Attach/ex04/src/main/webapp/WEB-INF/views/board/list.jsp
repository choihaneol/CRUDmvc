            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">  <!-- 패널은 콘텐츠가 있는 박스 형태의 구성요소  -->
                       ...
                       <tr>
              <td><c:out value="${board.bno}" /></td>   <!-- <td><a href='/board/get?bno=<c:out value="${board.bno}" />'>  --> <!-- 목록페이지에서 각 제목에 링크 설정-->
            
               <td>
                  <a class='move' href='<c:out value="${board.bno}"/>'>
                  <c:out value="${board.title}" />   <b>[  <c:out value="${board.replyCnt}" />  ]</b>  <!-- 댓글개수 출력되는 부분  -->
                  </a>  
