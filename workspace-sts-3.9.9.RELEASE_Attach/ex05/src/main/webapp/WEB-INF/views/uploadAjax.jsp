...
.bigPictureWrapper {
  ...
  background-color: gray; 
  z-index: 100;
  backgfound:rgba(255,255,255,0.5);
}
...
$(".uploadResult").on("click","span", function(e){ //<span>태그이용하여 처리. 첨부파일의 업로드후에 생서되기 때문에 이벤트위임 방식 
				 ...
				 var fileCallPath =  encodeURIComponent( obj.uploadPath+ "/s_"+obj.uuid +"_"+obj.fileName);
				  ...
				  var originPath = obj.uploadPath+ "\\"+obj.uuid +"_"+obj.fileName;  //첨부파일의 경우 업로드된 경로와 UUID가 붙은파일이름이 필요하므로 origin변수를 통해 하나의 문자열로 생성 
			       ...
			       str += "<li><a href=\"javascript:showImage(\'" + originPath 
		        		  + "\')\"><img src='/display?fileName="+fileCallPath+"'></a><li>"; //<a> 태그 추가 
