...
public class UploadController {
	...
	@PreAuthorize("isAuthenticated()") //현재사용자 권한 확인 
	@PostMapping("/uploadFormAction")
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) { 
	//MultipartFile:파일업로드시 하나의 <input>태그로 여러개의 파일을 업로드처리. 첨부파일 여러개 선택할수 있도록 배열타입 

		String uploadFolder = "/Users/angela/upload/"; //업로드될폴더명 (윈도우경로:"file:/C:/upload/tmp"
    ...
    public ResponseEntity<List<AttachFileDTO>> uploadAjaxPost(MultipartFile[] uploadFile) {//<form>방식과 달리 Ajax에서 리턴타입 달라져서 model타입 파라미터 빠짐 
	    ...
	    List<AttachFileDTO> list = new ArrayList<>(); //AttachFileDTO 리스트생성
		 String uploadFolder = "/Users/angela/upload"; //window:"C:\\upload";
